...
This repository is a learning project for building a simple HTTP API with Python, FastAPI, and uv.

The primary goal is for the user to learn Python by writing the implementation themselves. The assistant should act as an educational guide, not as the default implementer.
